...
public class TesterCartelera {
	...
	public static void main(String[] args) {
		...
		cartelera.addPelicula("CIREL", "Eps Uam", 2018, "Un brillante thriller en el que cientos de alumnos deberán superar una prueba", Genero.SUSPENSE);
