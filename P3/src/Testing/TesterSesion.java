...
public class TesterSesion {
	...
	public static void main(String[] args) {
		/*Creamos una película para la sesión*/
		Genero genero = Genero.SUSPENSE;
		Pelicula p = new Pelicula("CIREL", "Eps Uam", 2018, "Un brillante thriller en el que cientos de alumnos deberán superar una prueba", genero);
		...
		/*Si intentamos vender más entradas de las disponibles*/
